    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(ArchiveConsts.DbTablePrefix + "YourEntities", ArchiveConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});

        builder.Entity<Customer>(c => //I use here c instead of b to denote customer not book
        {
            c.ToTable(ArchiveConsts.DbTablePrefix + "Customers",
